...
\begin{frame}
  \begin{center}
    ...
    % Got job at REA after making a good impression with the CIO
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % Remembering when I cause production incidents
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % mind goes back to when I've internalised compliments and been rejected for those displays of confidence
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % Different from just being aware of your priveleges and that they help, attributing it too much to luck
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % Pick outliers that have excellent accomplishments that are older than me to compare myself to
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    attempt
    % Public speaking! Nervous about speaking even though I've done both of these talks before.
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    of  what  I’ve  done
    % Once I understand something it seems obvious and easy
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % again, picking the bad points of comparison
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % Pat on the ear for paying attention at the end of the conference, and remember you're all pawesome!
  \end{center}
\end{frame}
