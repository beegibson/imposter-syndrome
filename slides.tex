...
% Maybe higher in women, research goes both ways (citation?)
% Maybe higher in some ethnic group, studied in African Americans (citation?)
...
\begin{frame}
  \begin{center}
    ...
    \\ \small \cite{clanceimes78}
    % women more likely to attribute success to temp, external source - luck
    % more likely to attribute failure to self - ability
    % internalised sexism
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % repititions of success show dif between actual and ideal standards, make it worse
  \end{center}
\end{frame}
...
% descrepency between feedback and actual success
    % lack of positive reinforcement - ``nothing they do is ever good enough''
...
% "common among individuals with particular personality traits (e.g. neuroticism, conscientiousness, achievement-orientation), have perfectionist expectations over work"
    % inverse with conscientiousness? what was the source?
    \\ \small \cite{hh15}
    \\ \small \cite{sakulku11}
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % makes *lots* of sense for women in tech, since being since as competetent makes you less likeable
  \end{center}
\end{frame}
