...
\begin{frame}
  \begin{center}
    ...
    % Other people's praise can seem over the top, to me I'm normal. Once I know something it seems obvious and easy
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    \small
     ...
     % tendency to focus on what peers know that we don't \\
     % going back to the talk about picking what to learn - we can't learn everything! \\
...
\begin{frame}
  \begin{center}
    ...
    \\ \small \cite{sakulku11}
     ...
     % could be to avoid negative interpersonal implications of future failures and being seen as too confident\\
...
% Competetence makes us be perceived as more masculine -> pushy, bitch, sharp elbows, bossy etc
% think of all the crap women that are leaders take
% confidence also perceived as masculine - exacerbates those problems
% lack of confidence perceived as feminine - push us back in other direction
% less interpersonal consequences for our competetence
% cite what works for women at work
\end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    \\ \small \cite{clanceimes78}
     ...
     % or for a developer - implementing it how colleagues would want, not what you think is best\\
...
\begin{frame}
  \begin{center}
    ...
    \\ \small \cite{sakulku11}
    % For more about this, watch ducky's talk from Saturday
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    ...
    % Notes written at debriefs thanking eachother and giving nice feedback
	%lots of people saying similar stuff helped me internalise it
	%has to be true, or people learn to discount it. I've learned
	%to ignore positive feedback at work because it's generally been
	%dishonest
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    \Huge Meditation
    % start with compassion - rock the baby then self
    % appreciation - someone you admire, then admirable stuff in yourself
    % easiest where you share some traits - colleagues from volunteering
    % Then ask yourself: Is it completely true that I'm incompetent? That I don't do enough? That I don't try enough?
    % Is there any chance at all that isn't 100% true?
    % Positive statement: I am competent.
    % Is there any chance at all that is true?
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    \Huge Talk about it
    \small
     % discuss it with your peers, like the group therapy sessions
  \end{center}
\end{frame}
