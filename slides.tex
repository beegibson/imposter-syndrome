...
\begin{frame}
  \begin{center}
    \Huge active coping
    \\ \small \cite{hh15}
    % Active coping strategies involve an awareness of the stressor, followed by attempts to reduce the negative outcome - https://www.semel.ucla.edu/dual-diagnosis-program/News_and_Resources/How_Do_You_Cope
  \end{center}
\end{frame}
